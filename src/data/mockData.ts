...
export const products: Product[] = [
  { id: 'p1', name: 'Camisola Principal 24/25', clubId: 'c1', clubName: 'FC Estrela do Norte', category: 'Camisola', sport: 'Futebol', price: 49.99, sizes: ['S', 'M', 'L', 'XL', 'XXL'], stock: 120, image: 'https://images.unsplash.com/photo-1580089595767-98745d7025c5?w=400&h=500&fit=crop', description: 'Camisola principal sublimada com tecnologia de alta performance. Tecido respirável e leve.' },
  { id: 'p2', name: 'Camisola Alternativa 24/25', clubId: 'c1', clubName: 'FC Estrela do Norte', category: 'Camisola', sport: 'Futebol', price: 49.99, sizes: ['S', 'M', 'L', 'XL'], stock: 85, image: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=400&h=500&fit=crop', description: 'Design alternativo arrojado com padrão geométrico sublimado.' },
  { id: 'p3', name: 'Calções de Jogo', clubId: 'c2', clubName: 'SC Dragões do Mar', category: 'Calções', sport: 'Futebol', price: 29.99, sizes: ['S', 'M', 'L', 'XL'], stock: 200, image: 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400&h=500&fit=crop', description: 'Calções de jogo oficiais com elástico confortável e bolsos laterais.' },
  { id: 'p4', name: 'Equipamento Completo Sénior', clubId: 'c3', clubName: 'CF Leões da Serra', category: 'Kit Completo', sport: 'Futebol', price: 89.99, sizes: ['S', 'M', 'L', 'XL', 'XXL'], stock: 60, image: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=400&h=500&fit=crop', description: 'Kit completo: camisola, calções e meias. Ideal para equipar toda a equipa.' },
  { id: 'p5', name: 'Camisola de Treino', clubId: 'c4', clubName: 'AD Águias de Luanda', category: 'Camisola', sport: 'Futebol', price: 34.99, sizes: ['M', 'L', 'XL'], stock: 150, image: 'https://images.unsplash.com/photo-1551854838-212c50b4c184?w=400&h=500&fit=crop', description: 'Camisola de treino confortável com logo sublimado do clube.' },
  { id: 'p6', name: 'Fato de Treino Completo', clubId: 'c2', clubName: 'SC Dragões do Mar', category: 'Fato de Treino', sport: 'Futebol', price: 79.99, sizes: ['S', 'M', 'L', 'XL'], stock: 45, image: 'https://images.unsplash.com/photo-1515955656352-a1fa3ffcd111?w=400&h=500&fit=crop', description: 'Fato de treino premium com casaco e calças. Material de alta qualidade.' },
  { id: 'p7', name: 'Camisola de Futsal', clubId: 'c5', clubName: 'GD Tubarões do Sal', category: 'Camisola', sport: 'Futsal', price: 44.99, sizes: ['S', 'M', 'L', 'XL'], stock: 90, image: 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=400&h=500&fit=crop', description: 'Camisola de futsal com design vibrante e tecido ultra-leve.' },
  { id: 'p8', name: 'Meias de Jogo', clubId: 'c3', clubName: 'CF Leões da Serra', category: 'Meias', sport: 'Futebol', price: 12.99, sizes: ['36-39', '40-43', '44-47'], stock: 300, image: 'https://images.unsplash.com/photo-1556906781-9a412961c28c?w=400&h=500&fit=crop', description: 'Meias de jogo com reforço no calcanhar e biqueira. Conforto máximo.' },
  { id: 'p9', name: 'Camisola Guarda-Redes', clubId: 'c7', clubName: 'FC Tigres do Algarve', category: 'Camisola', sport: 'Futebol', price: 54.99, sizes: ['S', 'M', 'L', 'XL'], stock: 35, image: 'https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=400&h=500&fit=crop', description: 'Camisola de guarda-redes com acolchoamento nos cotovelos e design exclusivo.' },
  { id: 'p10', name: 'Polo Casual do Clube', clubId: 'c9', clubName: 'CF Unidos de Coimbra', category: 'Polo', sport: 'Futebol', price: 39.99, sizes: ['S', 'M', 'L', 'XL', 'XXL'], stock: 70, image: 'https://images.unsplash.com/photo-1625753783152-87afcbba7c3b?w=400&h=500&fit=crop', description: 'Polo casual elegante com logo bordado. Perfeito para representar o clube fora de campo.' },
];

export const orders: Order[] = [
  { id: 'o1', clubId: 'c1', clubName: 'FC Estrela do Norte', product: 'Camisola Principal 24/25', quantity: 50, status: 'entregue', deadline: '2025-01-15', total: 2499.50, createdAt: '2024-12-01' },
  ...
  { id: 'o8', clubId: 'c1', clubName: 'FC Estrela do Norte', product: 'Camisola Alternativa 24/25', quantity: 45, status: 'entregue', deadline: '2025-02-28', total: 2249.55, createdAt: '2025-01-15' },
  { id: 'o9', clubId: 'c6', clubName: 'SC Falcões de Maputo', product: 'Camisola Principal 24/25', quantity: 20, status: 'design', deadline: '2025-05-15', total: 999.80, createdAt: '2025-03-15' },
  ...
  { id: 'o11', clubId: 'c8', clubName: 'CD Panteras de Bissau', product: 'Camisola Principal 24/25', quantity: 30, status: 'sublimacao', deadline: '2025-04-10', total: 1499.70, createdAt: '2025-03-05' },
